...
sed -i -e "s/PBUR-HOMO-SIM/${PSIM}/g" \
	...
	-e "s/PBUR-HOMO-NRESP/${PNRESP}/g" \
	-e "s/BUR-HOMO-SIM/${SIM}/g" \
	-e "s/BUR-HOMO-NAO/${NAO}/g" \
	-e "s/BUR-HOMO-NSABE/${NSABE}/g" \
	-e "s/BUR-HOMO-NRESP/${NRESP}/g" $TABELA
